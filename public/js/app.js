...
function updateStatus(order) {
  ...
  statuses.forEach(function (payment_status) {
  ...
  statuses.forEach(function (status) {
    ...
    var dataProps = payment_status.dataset.status;
...
var socket = io();
Object(_admin__WEBPACK_IMPORTED_MODULE_2__["default"])(socket); // Join
...
socket.on('paymentUpdated', function (data) {
  var updatedPayment = _objectSpread({}, order);
...
__webpack_require__(/*! D:\real-time pizza\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\real-time pizza\resources\scss\app.scss */"./resources/scss/app.scss");
